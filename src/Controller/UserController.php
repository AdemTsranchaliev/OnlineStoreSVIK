...
class UserController extends AbstractController
{
    ...
    {
        return $this->render("user/seeCart.html.twig");
    }
                        ...
                        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
                                    ...
                                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            <td class="logo" style="text-align: left;">
                                                <h1><a href="https://obuvkisvik.com">
                                                        <img src="https://obuvkisvik.com/assets/images/logo.png" height="90">
                                                    </a></h1>
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <tr>
                                <table class="bg_white" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
                                        <th width="70%"
                                            style="text-align:left; padding: 0 2.5em; color: #000; padding-bottom: 20px">
                                            Продукт(номер/кол.)</th>
                                        <th width="30%"
